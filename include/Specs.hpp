...
#define GPU_TEXTURE_EXTRA_WIDTH 28
#define GPU_VIDEO_WIDTH         400
#define GPU_VIDEO_HEIGHT        240
#define GPU_VIDEO_MEM_SIZE      (GPU_VIDEO_WIDTH*GPU_VIDEO_HEIGHT)
#define GPU_TEXTURE_MEM_SIZE    ((GPU_VIDEO_WIDTH+GPU_TEXTURE_EXTRA_WIDTH*4)*GPU_VIDEO_HEIGHT)
...
#define MOUSE_SCOLL_LENGTH      1
#define MOUSE_SCOLL_AMOUNT      2

#define MOUSE_MEM_SIZE          (MOUSE_COORDINATE_LENGTH*MOUSE_COORDINATE_AMOUNT+\
                                 MOUSE_BUTTON_LENGTH*MOUSE_BUTTON_AMOUNT+\
                                 MOUSE_SCOLL_LENGTH*MOUSE_SCOLL_AMOUNT)
