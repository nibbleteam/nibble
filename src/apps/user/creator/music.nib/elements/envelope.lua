...
return {
    ...
    draw = function (self)
        ...
        circf(self.x+self.ballx.value, self.y+self.bally.value+3, 3, 1)
        circf(self.x+self.ballx.value, self.y+self.bally.value, 3, color)
        circf(self.x+self.ballx.value+1, self.y+self.bally.value-1, 1, 15)
